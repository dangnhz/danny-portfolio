    ...
    <div class="section-about m-auto">
      <div class="row">
        ...
        <div class="col-md-6 col-sm-12 col-xs-12 about-content" >
          ...
          <a href="https://dangnhz.github.io/cv/Dang_Resume.pdf" class="btn flat-btn">MY RESUME</a>
        </div>
      </div>
    </div>
